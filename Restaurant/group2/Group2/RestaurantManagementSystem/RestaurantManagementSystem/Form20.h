...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->listView1->Location = System::Drawing::Point(35, 88);
			this->listView1->Name = L"listView1";
			this->listView1->Size = System::Drawing::Size(572, 373);
			...
			// columnHeader2
			// 
			this->columnHeader2->Text = L"Employee name";
			this->columnHeader2->Width = 155;
			// 
			// columnHeader3
			// 
			this->columnHeader3->Text = L"Username";
			this->columnHeader3->Width = 147;
			// 
			// columnHeader4
			// 
			this->columnHeader4->Text = L"Last Log in date";
			this->columnHeader4->Width = 102;
			// 
			// columnHeader5
			// 
			this->columnHeader5->Text = L"Customers Serviced ";
			...
			this->menuStrip1->ItemClicked += gcnew System::Windows::Forms::ToolStripItemClickedEventHandler(this, &Form20::menuStrip1_ItemClicked_1);
			// 
			...
			this->homeToolStripMenuItem->Click += gcnew System::EventHandler(this, &Form20::homeToolStripMenuItem_Click);
			// 
			...
			this->logOutToolStripMenuItem->Click += gcnew System::EventHandler(this, &Form20::logOutToolStripMenuItem_Click);
			// 
			...
			this->quitToolStripMenuItem->Click += gcnew System::EventHandler(this, &Form20::quitToolStripMenuItem_Click);
			// 
			...
			this->aboutToolStripMenuItem->Click += gcnew System::EventHandler(this, &Form20::aboutToolStripMenuItem_Click);
			// 
			// Form20
			// 
